...
(function($PS) {
  // Generated by purs version 0.14.7
  "use strict";
  $PS["FRP.Event.Phantom"] = $PS["FRP.Event.Phantom"] || {};
  var exports = $PS["FRP.Event.Phantom"];
  var FRP_Event = $PS["FRP.Event"];                
  var PhantomEvent = function (x) {
      return x;
  };
  var plusPhantomEvent = FRP_Event.plusEvent;
  var isEventPhantomEvent = FRP_Event.eventIsEvent;
  var functorPhantomEvent = FRP_Event.functorEvent;
  var unsafePhantom = PhantomEvent;
  var toEvent = function (v) {
      return v;
  };
  var proof0 = PhantomEvent;
  exports["unsafePhantom"] = unsafePhantom;
  exports["proof0"] = proof0;
  exports["toEvent"] = toEvent;
  exports["functorPhantomEvent"] = functorPhantomEvent;
  exports["isEventPhantomEvent"] = isEventPhantomEvent;
  exports["plusPhantomEvent"] = plusPhantomEvent;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.7
  "use strict";
  ...
  var FRP_Behavior = $PS["FRP.Behavior"];
  var FRP_Event = $PS["FRP.Event"];
  var FRP_Event_Phantom = $PS["FRP.Event.Phantom"];                
  var effectfulDOMInterpret = {
      ids: Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event_Phantom.functorPhantomEvent))(Data_Show.show(Data_Show.showNumber))(FRP_Behavior.behavior(function (f) {
          return FRP_Event_Phantom.unsafePhantom(FRP_Event.makeEvent(function (k) {
              return function __do() {
                  var r = Effect_Random.random();
                  return FRP_Event.subscribe(FRP_Event_Phantom.toEvent(f))(function (x) {
                      return k(x(r));
                  })();
              };
          }));
                  ...
                  return Data_Exists.runExists(function (v1) {
                      return function __do() {
                          ...
                          var actualized = (function () {
                              var v2 = v1(evtR.push)(FRP_Event_Phantom.unsafePhantom(event));
      ...
      return function (psh) {
          return function (mksn) {
              return function __do() {
                  ...
                  var evt = Deku_Control.deku(FRP_Event_Phantom.isEventPhantomEvent)(elt)(mksn(v.push)(FRP_Event_Phantom.proof0(v.event)))(Deku_Interpret.effectfulDOMInterpret);
                  Data_Functor["void"](Effect.functorEffect)(FRP_Event.subscribe(FRP_Event_Phantom.toEvent(evt))(function (i) {
                      return i(ffi);
                  }))();
                  return v.push(psh)();
              };
...
(function($PS) {
  ...
  var main = Deku_Toplevel.runInBody(Data_Unit.unit)(function (v) {
      return function (v1) {
          ...
          })()(Deku_Pursx.pursxToElementNil(FRP_Event_Phantom.plusPhantomEvent))(FRP_Event_Phantom.isEventPhantomEvent)(px);
      };
  });
  exports["px"] = px;
  exports["main"] = main;
