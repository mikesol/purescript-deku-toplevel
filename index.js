...
(function($PS) {
  ...
  var main = Deku_Toplevel.runInBody(Deku_Create.createAll())()(function (push) {
      return Deku_Control_Functions.u(Deku_Pursx.psxR({
          ...
          mydiv: [  ],
          mybutton: Deku_Graph_DOM.button([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](push(Data_Unit.unit)))) ])({})
      }));
  })(function (v) {
